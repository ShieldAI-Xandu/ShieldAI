...
export const SECURITY_REFERENCES = [
  ...
  { id: "nvd",     name: "NVD — National Vulnerability Database", url: "https://nvd.nist.gov",
    org: "NIST", purpose: "CVE records enriched with CVSS severity scores and affected-product data. ShieldAI vCISO queries this live." },
  ...
  { id: "nist_csf", name: "NIST Cybersecurity Framework", url: "https://www.nist.gov/cyberframework",
    org: "NIST", purpose: "The framework ShieldAI vCISO's deterministic posture score is built on." },
