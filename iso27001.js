...
export const ISO27001_ANNEX_A = [
  ...
  { id: "A.5.1", theme: "organizational", title: "Policies for information security", covers: "A defined set of security policies, approved by management, published, and reviewed at planned intervals.", evidence: ["documentedPolicies", "policyReviewCadence"] },
  { id: "A.5.2", theme: "organizational", title: "Information security roles and responsibilities", covers: "Security roles defined and allocated according to organizational needs.", evidence: ["securityOwnership"] },
  ...
  { id: "A.5.4", theme: "organizational", title: "Management responsibilities", covers: "Management requiring all personnel to apply security in line with established policy.", evidence: ["securityOwnership", "documentedPolicies"] },
  ...
  { id: "A.5.9", theme: "organizational", title: "Inventory of information and other associated assets", covers: "An inventory of information and associated assets, with owners identified.", evidence: ["dataInventory", "vendorInventory"] },
  ...
  { id: "A.5.15", theme: "organizational", title: "Access control", covers: "Rules controlling physical and logical access based on business and security requirements.", evidence: ["mfa", "accessReviews", "privilegedAccess"] },
  { id: "A.5.16", theme: "organizational", title: "Identity management", covers: "The full lifecycle of identities.", evidence: ["mfa", "offboarding"] },
  { id: "A.5.17", theme: "organizational", title: "Authentication information", covers: "Allocation and management of authentication information, including advising users on handling it.", evidence: ["mfa", "passwordPolicy"] },
  { id: "A.5.18", theme: "organizational", title: "Access rights", covers: "Provisioning, review, modification, and removal of access rights in line with policy.", evidence: ["mfa", "accessReviews", "offboarding"] },
  { id: "A.5.19", theme: "organizational", title: "Information security in supplier relationships", covers: "Processes to manage the security risks that come with using suppliers.", evidence: ["vendorDueDiligence", "vendorInventory"] },
  { id: "A.5.20", theme: "organizational", title: "Addressing information security within supplier agreements", covers: "Security requirements established and agreed with each supplier.", evidence: ["vendorContracts"] },
  { id: "A.5.21", theme: "organizational", title: "Managing information security in the ICT supply chain", covers: "Managing security risks across the ICT products and services supply chain.", evidence: ["vendorDueDiligence", "vendorContracts"] },
  { id: "A.5.22", theme: "organizational", title: "Monitoring, review and change management of supplier services", covers: "Regularly monitoring and reviewing supplier service delivery and changes.", evidence: ["vendorDueDiligence", "monitoring"] },
  { id: "A.5.23", theme: "organizational", title: "Information security for use of cloud services", covers: "Acquiring, using, managing, and exiting cloud services in line with security requirements.", evidence: ["vendorDueDiligence", "vendorInventory"] },
  ...
  { id: "A.5.31", theme: "organizational", title: "Legal, statutory, regulatory and contractual requirements", covers: "Identifying and keeping current the legal and contractual security requirements you're subject to.", evidence: ["documentedPolicies", "policyReviewCadence"] },
  ...
  { id: "A.5.35", theme: "organizational", title: "Independent review of information security", covers: "Independent review of the security approach at planned intervals or after significant change.", evidence: ["priorAudit", "riskAssessmentCadence"] },
  { id: "A.5.36", theme: "organizational", title: "Compliance with policies, rules and standards for information security", covers: "Regularly reviewing compliance with your own security policies and standards.", evidence: ["policyReviewCadence", "documentedPolicies"] },
  { id: "A.5.37", theme: "organizational", title: "Documented operating procedures", covers: "Operating procedures documented and made available to those who need them.", evidence: ["documentedPolicies", "policyReviewCadence"] },
  ...
  { id: "A.6.5", theme: "people", title: "Responsibilities after termination or change of employment", covers: "Security responsibilities that survive someone leaving or changing role.", evidence: ["offboarding"] },
  ...
  // ── A.7 Physical (14) ──
  { id: "A.7.1", theme: "physical", title: "Physical security perimeters", covers: "Perimeters defined and used to protect areas holding information and assets.", evidence: ["physicalSecurity"] },
  { id: "A.7.2", theme: "physical", title: "Physical entry", covers: "Secure areas protected by appropriate entry controls and access points.", evidence: ["physicalSecurity"] },
  { id: "A.7.3", theme: "physical", title: "Securing offices, rooms and facilities", covers: "Physical security designed and implemented for offices, rooms, and facilities.", evidence: ["physicalSecurity"] },
  { id: "A.7.4", theme: "physical", title: "Physical security monitoring", covers: "Premises continuously monitored for unauthorized physical access.", evidence: ["physicalSecurity"] },
  ...
  { id: "A.7.6", theme: "physical", title: "Working in secure areas", covers: "Security measures for working in secure areas.", evidence: ["physicalSecurity"] },
  ...
  { id: "A.7.10", theme: "physical", title: "Storage media", covers: "Storage media managed through acquisition, use, transport, and disposal.", evidence: ["mediaDisposal", "encryptionAtRest"] },
  ...
  { id: "A.7.14", theme: "physical", title: "Secure disposal or re-use of equipment", covers: "Verifying that sensitive data and licensed software are removed before disposal or re-use.", evidence: ["mediaDisposal"] },
  ...
  { id: "A.8.2", theme: "technological", title: "Privileged access rights", covers: "Restricting and managing the allocation and use of privileged access.", evidence: ["privilegedAccess"] },
  { id: "A.8.3", theme: "technological", title: "Information access restriction", covers: "Access to information restricted in line with the access control policy.", evidence: ["mfa", "accessReviews"] },
  ...
  { id: "A.8.5", theme: "technological", title: "Secure authentication", covers: "Authentication technologies and procedures based on access restrictions and policy.", evidence: ["mfa", "passwordPolicy"] },
  ...
  { id: "A.8.8", theme: "technological", title: "Management of technical vulnerabilities", covers: "Obtaining information about technical vulnerabilities, evaluating exposure, and acting.", evidence: ["vulnManagement", "monitoring"] },
  { id: "A.8.9", theme: "technological", title: "Configuration management", covers: "Establishing, documenting, implementing, monitoring, and reviewing configurations.", evidence: ["changeManagement", "itManagement"] },
  { id: "A.8.10", theme: "technological", title: "Information deletion", covers: "Deleting information when no longer required.", evidence: ["dataRetention", "dataInventory"] },
  { id: "A.8.11", theme: "technological", title: "Data masking", covers: "Data masking used in line with access control policy and applicable requirements.", evidence: ["encryptionAtRest", "dataInventory"] },
  ...
  { id: "A.8.16", theme: "technological", title: "Monitoring activities", covers: "Networks, systems, and applications monitored for anomalous behaviour and evaluated.", evidence: ["monitoring", "vulnManagement"] },
  ...
  { id: "A.8.19", theme: "technological", title: "Installation of software on operational systems", covers: "Procedures to securely manage software installation on operational systems.", evidence: ["changeManagement", "endpoint"] },
  ...
  { id: "A.8.24", theme: "technological", title: "Use of cryptography", covers: "Rules for effective use of cryptography, including key management.", evidence: ["encryptionAtRest", "encryptionInTransit"] },
  ...
  { id: "A.8.32", theme: "technological", title: "Change management", covers: "Changes to information processing facilities and systems subject to change management procedures.", evidence: ["changeManagement", "documentedPolicies"] },
  ...
  { id: "A.8.34", theme: "technological", title: "Protection of information systems during audit testing", covers: "Audit tests on operational systems planned and agreed to minimise disruption.", evidence: ["priorAudit", "riskAssessmentCadence"] },
];
