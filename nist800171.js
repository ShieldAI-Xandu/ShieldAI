...
export const NIST800171_CONTROLS = [
  ...
  { id: "3.1.1", family: "AC", covers: "Limit system access to authorized users, processes acting on their behalf, and devices.", evidence: ["mfa", "accessReviews"] },
  { id: "3.1.2", family: "AC", covers: "Limit system access to the types of transactions and functions authorized users are permitted to execute.", evidence: ["mfa", "accessReviews"] },
  { id: "3.1.3", family: "AC", covers: "Control the flow of CUI in accordance with approved authorizations.", evidence: ["dataInventory"] },
  { id: "3.1.4", family: "AC", covers: "Separate the duties of individuals to reduce the risk of malevolent activity without collusion.", evidence: ["privilegedAccess", "documentedPolicies"] },
  { id: "3.1.5", family: "AC", covers: "Employ the principle of least privilege, including for privileged accounts.", evidence: ["privilegedAccess"] },
  { id: "3.1.6", family: "AC", covers: "Use non-privileged accounts when accessing non-security functions.", evidence: ["privilegedAccess"] },
  { id: "3.1.7", family: "AC", covers: "Prevent non-privileged users from executing privileged functions; capture such attempts in audit logs.", evidence: ["privilegedAccess", "monitoring"] },
  { id: "3.1.8", family: "AC", covers: "Limit unsuccessful logon attempts.", evidence: ["passwordPolicy"] },
  ...
  { id: "3.1.10", family: "AC", covers: "Use session lock with pattern-hiding displays after a period of inactivity.", evidence: ["accessReviews"] },
  ...
  { id: "3.1.13", family: "AC", covers: "Employ cryptographic mechanisms to protect the confidentiality of remote access sessions.", evidence: ["encryptionInTransit"] },
  ...
  { id: "3.1.17", family: "AC", covers: "Protect wireless access using authentication and encryption.", evidence: ["encryptionInTransit"] },
  { id: "3.1.18", family: "AC", covers: "Control connection of mobile devices.", evidence: ["endpoint"] },
  { id: "3.1.19", family: "AC", covers: "Encrypt CUI on mobile devices and mobile computing platforms.", evidence: ["encryptionAtRest"] },
  ...
  { id: "3.3.8", family: "AU", covers: "Protect audit information and logging tools from unauthorized access, modification, and deletion.", evidence: ["monitoring", "privilegedAccess"] },
  { id: "3.3.9", family: "AU", covers: "Limit management of audit logging functionality to a subset of privileged users.", evidence: ["privilegedAccess"] },
  ...
  { id: "3.4.3", family: "CM", covers: "Track, review, approve or disapprove, and log changes to systems.", evidence: ["changeManagement"] },
  { id: "3.4.4", family: "CM", covers: "Analyze the security impact of changes prior to implementation.", evidence: ["changeManagement"] },
  { id: "3.4.5", family: "CM", covers: "Define, document, approve, and enforce physical and logical access restrictions associated with changes.", evidence: ["changeManagement", "privilegedAccess"] },
  ...
  { id: "3.4.9", family: "CM", covers: "Control and monitor user-installed software.", evidence: ["changeManagement", "endpoint"] },
  ...
  { id: "3.5.7", family: "IA", covers: "Enforce a minimum password complexity and change of characters when new passwords are created.", evidence: ["passwordPolicy"] },
  { id: "3.5.8", family: "IA", covers: "Prohibit password reuse for a specified number of generations.", evidence: ["passwordPolicy"] },
  { id: "3.5.9", family: "IA", covers: "Allow temporary password use for system logons with an immediate change to a permanent password.", evidence: ["passwordPolicy"] },
  { id: "3.5.10", family: "IA", covers: "Store and transmit only cryptographically-protected passwords.", evidence: ["passwordPolicy", "encryptionAtRest"] },
  ...
  { id: "3.7.5", family: "MA", covers: "Require multifactor authentication to establish nonlocal maintenance sessions, and terminate them when complete.", evidence: ["mfa", "encryptionInTransit"] },
  ...
  { id: "3.8.1", family: "MP", covers: "Protect system media containing CUI, both paper and digital.", evidence: ["mediaDisposal", "encryptionAtRest"] },
  { id: "3.8.2", family: "MP", covers: "Limit access to CUI on system media to authorized users.", evidence: ["accessReviews"] },
  { id: "3.8.3", family: "MP", covers: "Sanitize or destroy system media containing CUI before disposal or release for reuse.", evidence: ["mediaDisposal"] },
  ...
  { id: "3.8.6", family: "MP", covers: "Implement cryptographic mechanisms to protect the confidentiality of CUI stored on digital media during transport.", evidence: ["encryptionInTransit"] },
  { id: "3.8.7", family: "MP", covers: "Control the use of removable media on system components.", evidence: ["mediaDisposal"] },
  ...
  { id: "3.8.9", family: "MP", covers: "Protect the confidentiality of backup CUI at storage locations.", evidence: ["backups", "encryptionAtRest"] },
  ...
  { id: "3.9.2", family: "PS", covers: "Ensure CUI and systems are protected during and after personnel actions such as terminations and transfers.", evidence: ["offboarding"] },

  // ── 3.10 Physical Protection (6) ──
  { id: "3.10.1", family: "PE", covers: "Limit physical access to systems, equipment, and operating environments to authorized individuals.", evidence: ["physicalSecurity"] },
  { id: "3.10.2", family: "PE", covers: "Protect and monitor the physical facility and support infrastructure.", evidence: ["physicalSecurity"] },
  { id: "3.10.3", family: "PE", covers: "Escort visitors and monitor visitor activity.", evidence: ["physicalSecurity"] },
  { id: "3.10.4", family: "PE", covers: "Maintain audit logs of physical access.", evidence: ["physicalSecurity"] },
  { id: "3.10.5", family: "PE", covers: "Control and manage physical access devices.", evidence: ["physicalSecurity"] },
  ...
  { id: "3.11.2", family: "RA", covers: "Scan for vulnerabilities in systems and applications periodically and when new vulnerabilities are identified.", evidence: ["vulnManagement"] },
  { id: "3.11.3", family: "RA", covers: "Remediate vulnerabilities in accordance with risk assessments.", evidence: ["vulnManagement"] },

  // ── 3.12 Security Assessment (4) ──
  { id: "3.12.1", family: "CA", covers: "Periodically assess security controls to determine whether they are effective in their application.", evidence: ["riskAssessmentCadence", "priorAudit"] },
  ...
  { id: "3.12.3", family: "CA", covers: "Monitor security controls on an ongoing basis to ensure their continued effectiveness.", evidence: ["monitoring", "riskAssessmentCadence"] },
  ...
  { id: "3.13.8", family: "SC", covers: "Implement cryptographic mechanisms to prevent unauthorized disclosure of CUI during transmission unless otherwise protected.", evidence: ["encryptionInTransit"] },
  { id: "3.13.9", family: "SC", covers: "Terminate network connections at the end of sessions or after a period of inactivity.", evidence: [] },
  { id: "3.13.10", family: "SC", covers: "Establish and manage cryptographic keys for cryptography employed in systems.", evidence: ["encryptionAtRest"] },
  { id: "3.13.11", family: "SC", covers: "Employ FIPS-validated cryptography when used to protect the confidentiality of CUI.", evidence: ["encryptionAtRest", "encryptionInTransit"] },
  ...
  { id: "3.13.16", family: "SC", covers: "Protect the confidentiality of CUI at rest.", evidence: ["encryptionAtRest"] },

  // ── 3.14 System and Information Integrity (7) ──
  { id: "3.14.1", family: "SI", covers: "Identify, report, and correct system flaws in a timely manner.", evidence: ["vulnManagement", "endpoint"] },
