...
function AIChip({ model }) {
  ...
  return (
    <span title={`Generated by Mastermind — ${m.label} handled this task (${m.specialty}).`}
    ...
    <div style={{minHeight:"100vh",background:C.bg,display:"flex",alignItems:"center",
      ...
      <div style={{width:"100%",maxWidth:520,textAlign:"center"}}>
        ...
        <p style={{color:C.textSec,marginBottom:32,fontSize:14}}>
          3 specialized AI engines generating 10 components of your customized cybersecurity program
        </p>
      ...
      <div style={{width:220,flexShrink:0,background:C.surface,borderRight:`1px solid ${C.border}`,
        ...
        <div style={{padding:"12px 14px",borderBottom:`1px solid ${C.border}`}}>
          ...
          <div style={{fontSize:9.5,color:C.textMut,lineHeight:1.4,marginBottom:8}}>
            3 specialized AI engines behind every generated section
          </div>
          {Object.values(AI_MODELS).map(m=>(
            <div key={m.id} style={{display:"flex",alignItems:"center",gap:7,marginBottom:5}}>
              ...
              <span style={{fontSize:9.5,color:C.textMut}}>· {m.specialty.split(",")[0]}</span>
            </div>
          ))}
        </div>
...
function MarketingPage({ onEnterApp, onLogin, onStartDemo, onRedeemCode, onOpenInvestor,
  ...
  return (
    <div className="mkt-root" style={{background:deep,color:ink,fontFamily:"Inter,system-ui,sans-serif",minHeight:"100vh"}}>
      ...
      {/* Per explicit direction (2026-07-23): name the vendors. Reverses the
          earlier "don't name model providers" approach — the call now is that
          Claude/Gemini/ChatGPT's own credibility is a trust signal worth
          spending, not a "just a wrapper" risk worth avoiding. If this ever
          flips back, the agent-role framing (Analyst/Intelligence/Advisory)
          still works without vendor names — see the labels below. */}
