...
{"threatLandscape":{"industryThreats":[{"name":"","description":"1 sentence","prevalence":"High|Medium|Low","mitigations":["mitigation 1","mitigation 2"]}],"recentCVEs":[{"id":"CVE-XXXX-XXXXX","description":"1 sentence","severity":"Critical|High|Medium","affected":"","patch":"1 sentence"}],"darkWebMentions":"No intel|Low risk|Elevated|High alert"}}
Limit industryThreats to 3 and recentCVEs to 2. Use realistic, plausible (not necessarily real) CVE-style IDs and descriptions appropriate for the business's industry and tech stack.`,
  },
  {
    key: "tools",
